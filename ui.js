...
function showReport()
{
  ...
  for (const resource of snapshot.resources)
  {
    ...
    htmlContent += "<tr><th rowspan='" + Object.keys(resource.properties).length + "' style='border:1px solid black;'></th><th colspan='2' style='border:1px solid black;'>" + resource.displayName + "</th></tr>";
