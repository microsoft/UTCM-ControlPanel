...
function showReport()
{
  ...
  for (const resource of snapshot.resources)
  {
    ...
    htmlContent += "<tr><th width='75px' rowspan='" + (Object.keys(resource.properties).length+1) + "' style='border:1px solid black;'><img src='images/" + resourceWorkload + ".png' alt='" + resourceWorkload + "' /></th><th colspan='2' style='border:1px solid black;'>" + resource.displayName + "</th></tr>";
